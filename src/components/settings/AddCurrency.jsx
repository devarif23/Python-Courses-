    ...
    return (
        <>
            <div className="cba-add-currency-container">
                ...
                {/* currency add container */}
                <div className="cba-addcur-inner-container">
                    {/* head part */}
                    <div className="cba-addcur-ic-head-part">
                        <h1>Add Currency</h1>
                        <a href="/CurrencyList-page"><i className='cba-addcur-list-page-icon bx bx-list-ul' ></i> Currency List</a>
                    </div>
                    {/* middle part */}
                    <div className="cba-addcur-ic-middle-part">
                        <div className="cba-addcur-ic-mp-input-box1">
                            <label htmlFor="">Title<span className="cba-addcur-required">*</span></label>
                            <input type="text" placeholder="Title" required />
                        </div>
                        <div className="cba-addcur-ic-mp-input-box2">
                            <label htmlFor="">Symbol<span className="cba-addcur-required">*</span></label>
                            <input type="text" placeholder="Symbol" required />
                        </div>
                        <div className="cba-addcur-ic-mp-select-box">
                            <label htmlFor="">Country<span className="cba-addcur-required">*</span></label>
                            <select id="" name="">
                        ...
                        <div className="cba-addcur-ic-mp-status-box">
                            <label htmlFor="">Status<span className="cba-addcur-required">*</span></label>
                            <div>
                                <div>
                    ...
                    {/* bottom part */}
                    <div className="cba-addcur-ic-bottom-part">
